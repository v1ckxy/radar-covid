...
public final class AesGcmKey extends C3731z<AesGcmKey, Builder> implements AesGcmKeyOrBuilder {
    public static final AesGcmKey DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    public static volatile C3739z0<AesGcmKey> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    public C3635j keyValue_ = C3635j.f9034f;
    public int version_;

    /* renamed from: com.google.crypto.tink.proto.AesGcmKey$1 */
    public static /* synthetic */ class C02751 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1473xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1473xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1473xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1473xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1473xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesGcmKey.C02751.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesGcmKey, Builder> implements AesGcmKeyOrBuilder {
        public Builder() {
            super(AesGcmKey.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02751 r1) {
            this();
        }
        ...
        public Builder setKeyValue(C3635j jVar) {
            copyOnWrite();
            ((AesGcmKey) this.instance).setKeyValue(jVar);
            return this;
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesGcmKey.class, aesGcmKey);
    }
    ...
    public static AesGcmKey parseDelimitedFrom(InputStream inputStream) {
        return (AesGcmKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesGcmKey parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesGcmKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesGcmKey parseFrom(InputStream inputStream) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesGcmKey parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesGcmKey parseFrom(ByteBuffer byteBuffer) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesGcmKey parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesGcmKey parseFrom(C3635j jVar) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesGcmKey parseFrom(C3635j jVar, C3697r rVar) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesGcmKey parseFrom(C3656k kVar) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesGcmKey parseFrom(C3656k kVar, C3697r rVar) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesGcmKey parseFrom(byte[] bArr) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesGcmKey parseFrom(byte[] bArr, C3697r rVar) {
        return (AesGcmKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesGcmKey> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesGcmKey> z0Var = PARSER;
                if (z0Var == null) {
