...
public final class AesCtrHmacAeadKey extends C3731z<AesCtrHmacAeadKey, Builder> implements AesCtrHmacAeadKeyOrBuilder {
    public static final int AES_CTR_KEY_FIELD_NUMBER = 2;
    public static final AesCtrHmacAeadKey DEFAULT_INSTANCE;
    public static final int HMAC_KEY_FIELD_NUMBER = 3;
    public static volatile C3739z0<AesCtrHmacAeadKey> PARSER = null;
    ...
    public static /* synthetic */ class C02611 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1459xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1459xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1459xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1459xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1459xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesCtrHmacAeadKey.C02611.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesCtrHmacAeadKey, Builder> implements AesCtrHmacAeadKeyOrBuilder {
        public Builder() {
            super(AesCtrHmacAeadKey.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02611 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesCtrHmacAeadKey.class, aesCtrHmacAeadKey);
    }
    ...
    public void mergeAesCtrKey(AesCtrKey aesCtrKey) {
        ...
        if (!(aesCtrKey2 == null || aesCtrKey2 == AesCtrKey.getDefaultInstance())) {
            aesCtrKey = (AesCtrKey) ((com.google.crypto.tink.proto.AesCtrKey.Builder) AesCtrKey.newBuilder(this.aesCtrKey_).mergeFrom(aesCtrKey)).buildPartial();
        }
    ...
    public void mergeHmacKey(HmacKey hmacKey) {
        ...
        if (!(hmacKey2 == null || hmacKey2 == HmacKey.getDefaultInstance())) {
            hmacKey = (HmacKey) ((com.google.crypto.tink.proto.HmacKey.Builder) HmacKey.newBuilder(this.hmacKey_).mergeFrom(hmacKey)).buildPartial();
        }
    ...
    public static AesCtrHmacAeadKey parseDelimitedFrom(InputStream inputStream) {
        return (AesCtrHmacAeadKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesCtrHmacAeadKey parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesCtrHmacAeadKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesCtrHmacAeadKey parseFrom(InputStream inputStream) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesCtrHmacAeadKey parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesCtrHmacAeadKey parseFrom(ByteBuffer byteBuffer) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesCtrHmacAeadKey parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesCtrHmacAeadKey parseFrom(C3635j jVar) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesCtrHmacAeadKey parseFrom(C3635j jVar, C3697r rVar) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesCtrHmacAeadKey parseFrom(C3656k kVar) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesCtrHmacAeadKey parseFrom(C3656k kVar, C3697r rVar) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesCtrHmacAeadKey parseFrom(byte[] bArr) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesCtrHmacAeadKey parseFrom(byte[] bArr, C3697r rVar) {
        return (AesCtrHmacAeadKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesCtrHmacAeadKey> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return C3731z.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\u000b\u0002\t\u0003\t", new Object[]{"version_", "aesCtrKey_", "hmacKey_"});
            case 3:
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesCtrHmacAeadKey> z0Var = PARSER;
                if (z0Var == null) {
