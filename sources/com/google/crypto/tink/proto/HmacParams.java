...
public final class HmacParams extends C3731z<HmacParams, Builder> implements HmacParamsOrBuilder {
    public static final HmacParams DEFAULT_INSTANCE;
    public static final int HASH_FIELD_NUMBER = 1;
    public static volatile C3739z0<HmacParams> PARSER = null;
    public static final int TAG_SIZE_FIELD_NUMBER = 2;
    public int hash_;
    public int tagSize_;

    /* renamed from: com.google.crypto.tink.proto.HmacParams$1 */
    public static /* synthetic */ class C03051 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1503xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1503xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1503xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1503xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1503xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.HmacParams.C03051.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<HmacParams, Builder> implements HmacParamsOrBuilder {
        public Builder() {
            super(HmacParams.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C03051 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(HmacParams.class, hmacParams);
    }
    ...
    public static HmacParams parseDelimitedFrom(InputStream inputStream) {
        return (HmacParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static HmacParams parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (HmacParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static HmacParams parseFrom(InputStream inputStream) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static HmacParams parseFrom(InputStream inputStream, C3697r rVar) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static HmacParams parseFrom(ByteBuffer byteBuffer) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static HmacParams parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static HmacParams parseFrom(C3635j jVar) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static HmacParams parseFrom(C3635j jVar, C3697r rVar) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static HmacParams parseFrom(C3656k kVar) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static HmacParams parseFrom(C3656k kVar, C3697r rVar) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static HmacParams parseFrom(byte[] bArr) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static HmacParams parseFrom(byte[] bArr, C3697r rVar) {
        return (HmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<HmacParams> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return C3731z.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\f\u0002\u000b", new Object[]{"hash_", "tagSize_"});
            case 3:
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<HmacParams> z0Var = PARSER;
                if (z0Var == null) {
