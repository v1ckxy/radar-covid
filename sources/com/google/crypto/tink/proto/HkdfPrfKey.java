...
public final class HkdfPrfKey extends C3731z<HkdfPrfKey, Builder> implements HkdfPrfKeyOrBuilder {
    public static final HkdfPrfKey DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    public static final int PARAMS_FIELD_NUMBER = 2;
    public static volatile C3739z0<HkdfPrfKey> PARSER = null;
    ...
    public static /* synthetic */ class C03001 {
        ...
        public static final /* synthetic */ int[] f1498xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1498xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1498xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1498xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1498xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.HkdfPrfKey.C03001.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<HkdfPrfKey, Builder> implements HkdfPrfKeyOrBuilder {
        public Builder() {
            super(HkdfPrfKey.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C03001 r1) {
            this();
        }
        ...
        public Builder setKeyValue(C3635j jVar) {
            copyOnWrite();
            ((HkdfPrfKey) this.instance).setKeyValue(jVar);
            return this;
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(HkdfPrfKey.class, hkdfPrfKey);
    }
    ...
    public static HkdfPrfKey parseDelimitedFrom(InputStream inputStream) {
        return (HkdfPrfKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static HkdfPrfKey parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (HkdfPrfKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static HkdfPrfKey parseFrom(InputStream inputStream) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static HkdfPrfKey parseFrom(InputStream inputStream, C3697r rVar) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static HkdfPrfKey parseFrom(ByteBuffer byteBuffer) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static HkdfPrfKey parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static HkdfPrfKey parseFrom(C3635j jVar) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static HkdfPrfKey parseFrom(C3635j jVar, C3697r rVar) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static HkdfPrfKey parseFrom(C3656k kVar) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static HkdfPrfKey parseFrom(C3656k kVar, C3697r rVar) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static HkdfPrfKey parseFrom(byte[] bArr) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static HkdfPrfKey parseFrom(byte[] bArr, C3697r rVar) {
        return (HkdfPrfKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<HkdfPrfKey> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<HkdfPrfKey> z0Var = PARSER;
                if (z0Var == null) {
