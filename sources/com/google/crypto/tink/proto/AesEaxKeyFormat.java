...
public final class AesEaxKeyFormat extends C3731z<AesEaxKeyFormat, Builder> implements AesEaxKeyFormatOrBuilder {
    public static final AesEaxKeyFormat DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 2;
    public static final int PARAMS_FIELD_NUMBER = 1;
    public static volatile C3739z0<AesEaxKeyFormat> PARSER;
    public int keySize_;
    public AesEaxParams params_;

    /* renamed from: com.google.crypto.tink.proto.AesEaxKeyFormat$1 */
    public static /* synthetic */ class C02701 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1468xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1468xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1468xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1468xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1468xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesEaxKeyFormat.C02701.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesEaxKeyFormat, Builder> implements AesEaxKeyFormatOrBuilder {
        public Builder() {
            super(AesEaxKeyFormat.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02701 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesEaxKeyFormat.class, aesEaxKeyFormat);
    }
    ...
    public static AesEaxKeyFormat parseDelimitedFrom(InputStream inputStream) {
        return (AesEaxKeyFormat) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesEaxKeyFormat parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesEaxKeyFormat) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesEaxKeyFormat parseFrom(InputStream inputStream) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesEaxKeyFormat parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesEaxKeyFormat parseFrom(ByteBuffer byteBuffer) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesEaxKeyFormat parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesEaxKeyFormat parseFrom(C3635j jVar) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesEaxKeyFormat parseFrom(C3635j jVar, C3697r rVar) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesEaxKeyFormat parseFrom(C3656k kVar) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesEaxKeyFormat parseFrom(C3656k kVar, C3697r rVar) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesEaxKeyFormat parseFrom(byte[] bArr) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesEaxKeyFormat parseFrom(byte[] bArr, C3697r rVar) {
        return (AesEaxKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesEaxKeyFormat> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesEaxKeyFormat> z0Var = PARSER;
                if (z0Var == null) {
