...
public final class EciesAeadHkdfPrivateKey extends C3731z<EciesAeadHkdfPrivateKey, Builder> implements EciesAeadHkdfPrivateKeyOrBuilder {
    public static final EciesAeadHkdfPrivateKey DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    public static volatile C3739z0<EciesAeadHkdfPrivateKey> PARSER = null;
    public static final int PUBLIC_KEY_FIELD_NUMBER = 2;
    public static final int VERSION_FIELD_NUMBER = 1;
    public C3635j keyValue_ = C3635j.f9034f;
    public EciesAeadHkdfPublicKey publicKey_;
    public int version_;

    /* renamed from: com.google.crypto.tink.proto.EciesAeadHkdfPrivateKey$1 */
    public static /* synthetic */ class C02901 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1488xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1488xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1488xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1488xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1488xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.EciesAeadHkdfPrivateKey.C02901.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<EciesAeadHkdfPrivateKey, Builder> implements EciesAeadHkdfPrivateKeyOrBuilder {
        public Builder() {
            super(EciesAeadHkdfPrivateKey.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02901 r1) {
            this();
        }
        ...
        public Builder setKeyValue(C3635j jVar) {
            copyOnWrite();
            ((EciesAeadHkdfPrivateKey) this.instance).setKeyValue(jVar);
            return this;
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(EciesAeadHkdfPrivateKey.class, eciesAeadHkdfPrivateKey);
    }
    ...
    public void mergePublicKey(EciesAeadHkdfPublicKey eciesAeadHkdfPublicKey) {
        ...
        if (!(eciesAeadHkdfPublicKey2 == null || eciesAeadHkdfPublicKey2 == EciesAeadHkdfPublicKey.getDefaultInstance())) {
            eciesAeadHkdfPublicKey = (EciesAeadHkdfPublicKey) ((com.google.crypto.tink.proto.EciesAeadHkdfPublicKey.Builder) EciesAeadHkdfPublicKey.newBuilder(this.publicKey_).mergeFrom(eciesAeadHkdfPublicKey)).buildPartial();
        }
    ...
    public static EciesAeadHkdfPrivateKey parseDelimitedFrom(InputStream inputStream) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static EciesAeadHkdfPrivateKey parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(InputStream inputStream) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(InputStream inputStream, C3697r rVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(ByteBuffer byteBuffer) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(C3635j jVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(C3635j jVar, C3697r rVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(C3656k kVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(C3656k kVar, C3697r rVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(byte[] bArr) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static EciesAeadHkdfPrivateKey parseFrom(byte[] bArr, C3697r rVar) {
        return (EciesAeadHkdfPrivateKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<EciesAeadHkdfPrivateKey> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<EciesAeadHkdfPrivateKey> z0Var = PARSER;
                if (z0Var == null) {
