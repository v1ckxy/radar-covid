...
public final class XChaCha20Poly1305Key extends C3731z<XChaCha20Poly1305Key, Builder> implements XChaCha20Poly1305KeyOrBuilder {
    public static final XChaCha20Poly1305Key DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    public static volatile C3739z0<XChaCha20Poly1305Key> PARSER = null;
    ...
    public static /* synthetic */ class C03271 {
        ...
        public static final /* synthetic */ int[] f1532xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1532xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1532xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1532xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1532xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.XChaCha20Poly1305Key.C03271.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<XChaCha20Poly1305Key, Builder> implements XChaCha20Poly1305KeyOrBuilder {
        public Builder() {
            super(XChaCha20Poly1305Key.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C03271 r1) {
            this();
        }
        ...
        public Builder setKeyValue(C3635j jVar) {
            copyOnWrite();
            ((XChaCha20Poly1305Key) this.instance).setKeyValue(jVar);
            return this;
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(XChaCha20Poly1305Key.class, xChaCha20Poly1305Key);
    }
    ...
    public static XChaCha20Poly1305Key parseDelimitedFrom(InputStream inputStream) {
        return (XChaCha20Poly1305Key) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static XChaCha20Poly1305Key parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (XChaCha20Poly1305Key) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static XChaCha20Poly1305Key parseFrom(InputStream inputStream) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static XChaCha20Poly1305Key parseFrom(InputStream inputStream, C3697r rVar) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static XChaCha20Poly1305Key parseFrom(ByteBuffer byteBuffer) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static XChaCha20Poly1305Key parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static XChaCha20Poly1305Key parseFrom(C3635j jVar) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static XChaCha20Poly1305Key parseFrom(C3635j jVar, C3697r rVar) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static XChaCha20Poly1305Key parseFrom(C3656k kVar) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static XChaCha20Poly1305Key parseFrom(C3656k kVar, C3697r rVar) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static XChaCha20Poly1305Key parseFrom(byte[] bArr) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static XChaCha20Poly1305Key parseFrom(byte[] bArr, C3697r rVar) {
        return (XChaCha20Poly1305Key) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<XChaCha20Poly1305Key> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<XChaCha20Poly1305Key> z0Var = PARSER;
                if (z0Var == null) {
