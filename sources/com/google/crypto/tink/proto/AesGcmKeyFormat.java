...
public final class AesGcmKeyFormat extends C3731z<AesGcmKeyFormat, Builder> implements AesGcmKeyFormatOrBuilder {
    public static final AesGcmKeyFormat DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 2;
    public static volatile C3739z0<AesGcmKeyFormat> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 3;
    public int keySize_;
    public int version_;

    /* renamed from: com.google.crypto.tink.proto.AesGcmKeyFormat$1 */
    public static /* synthetic */ class C02761 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1474xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1474xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1474xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1474xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1474xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesGcmKeyFormat.C02761.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesGcmKeyFormat, Builder> implements AesGcmKeyFormatOrBuilder {
        public Builder() {
            super(AesGcmKeyFormat.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02761 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesGcmKeyFormat.class, aesGcmKeyFormat);
    }
    ...
    public static AesGcmKeyFormat parseDelimitedFrom(InputStream inputStream) {
        return (AesGcmKeyFormat) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesGcmKeyFormat parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesGcmKeyFormat) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesGcmKeyFormat parseFrom(InputStream inputStream) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesGcmKeyFormat parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesGcmKeyFormat parseFrom(ByteBuffer byteBuffer) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesGcmKeyFormat parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesGcmKeyFormat parseFrom(C3635j jVar) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesGcmKeyFormat parseFrom(C3635j jVar, C3697r rVar) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesGcmKeyFormat parseFrom(C3656k kVar) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesGcmKeyFormat parseFrom(C3656k kVar, C3697r rVar) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesGcmKeyFormat parseFrom(byte[] bArr) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesGcmKeyFormat parseFrom(byte[] bArr, C3697r rVar) {
        return (AesGcmKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesGcmKeyFormat> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return C3731z.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0002\u0003\u0002\u0000\u0000\u0000\u0002\u000b\u0003\u000b", new Object[]{"keySize_", "version_"});
            case 3:
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesGcmKeyFormat> z0Var = PARSER;
                if (z0Var == null) {
