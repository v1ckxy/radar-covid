...
public final class RsaSsaPssParams extends C3731z<RsaSsaPssParams, Builder> implements RsaSsaPssParamsOrBuilder {
    public static final RsaSsaPssParams DEFAULT_INSTANCE;
    public static final int MGF1_HASH_FIELD_NUMBER = 2;
    public static volatile C3739z0<RsaSsaPssParams> PARSER = null;
    ...
    public static /* synthetic */ class C03241 {
        ...
        public static final /* synthetic */ int[] f1524xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1524xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1524xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1524xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1524xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.RsaSsaPssParams.C03241.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<RsaSsaPssParams, Builder> implements RsaSsaPssParamsOrBuilder {
        public Builder() {
            super(RsaSsaPssParams.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C03241 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(RsaSsaPssParams.class, rsaSsaPssParams);
    }
    ...
    public static RsaSsaPssParams parseDelimitedFrom(InputStream inputStream) {
        return (RsaSsaPssParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static RsaSsaPssParams parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (RsaSsaPssParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static RsaSsaPssParams parseFrom(InputStream inputStream) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static RsaSsaPssParams parseFrom(InputStream inputStream, C3697r rVar) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static RsaSsaPssParams parseFrom(ByteBuffer byteBuffer) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static RsaSsaPssParams parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static RsaSsaPssParams parseFrom(C3635j jVar) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static RsaSsaPssParams parseFrom(C3635j jVar, C3697r rVar) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static RsaSsaPssParams parseFrom(C3656k kVar) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static RsaSsaPssParams parseFrom(C3656k kVar, C3697r rVar) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static RsaSsaPssParams parseFrom(byte[] bArr) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static RsaSsaPssParams parseFrom(byte[] bArr, C3697r rVar) {
        return (RsaSsaPssParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<RsaSsaPssParams> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return C3731z.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\f\u0002\f\u0003\u0004", new Object[]{"sigHash_", "mgf1Hash_", "saltLength_"});
            case 3:
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<RsaSsaPssParams> z0Var = PARSER;
                if (z0Var == null) {
