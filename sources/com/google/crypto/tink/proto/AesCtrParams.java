...
public final class AesCtrParams extends C3731z<AesCtrParams, Builder> implements AesCtrParamsOrBuilder {
    public static final AesCtrParams DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    public static volatile C3739z0<AesCtrParams> PARSER;
    public int ivSize_;

    /* renamed from: com.google.crypto.tink.proto.AesCtrParams$1 */
    public static /* synthetic */ class C02681 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1466xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1466xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1466xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1466xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1466xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesCtrParams.C02681.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesCtrParams, Builder> implements AesCtrParamsOrBuilder {
        public Builder() {
            super(AesCtrParams.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02681 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesCtrParams.class, aesCtrParams);
    }
    ...
    public static AesCtrParams parseDelimitedFrom(InputStream inputStream) {
        return (AesCtrParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesCtrParams parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesCtrParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesCtrParams parseFrom(InputStream inputStream) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesCtrParams parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesCtrParams parseFrom(ByteBuffer byteBuffer) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesCtrParams parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesCtrParams parseFrom(C3635j jVar) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesCtrParams parseFrom(C3635j jVar, C3697r rVar) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesCtrParams parseFrom(C3656k kVar) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesCtrParams parseFrom(C3656k kVar, C3697r rVar) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesCtrParams parseFrom(byte[] bArr) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesCtrParams parseFrom(byte[] bArr, C3697r rVar) {
        return (AesCtrParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesCtrParams> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return C3731z.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"ivSize_"});
            case 3:
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesCtrParams> z0Var = PARSER;
                if (z0Var == null) {
