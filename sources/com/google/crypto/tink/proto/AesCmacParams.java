...
public final class AesCmacParams extends C3731z<AesCmacParams, Builder> implements AesCmacParamsOrBuilder {
    public static final AesCmacParams DEFAULT_INSTANCE;
    public static volatile C3739z0<AesCmacParams> PARSER = null;
    public static final int TAG_SIZE_FIELD_NUMBER = 1;
    public int tagSize_;

    /* renamed from: com.google.crypto.tink.proto.AesCmacParams$1 */
    public static /* synthetic */ class C02601 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1458xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1458xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1458xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1458xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1458xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesCmacParams.C02601.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesCmacParams, Builder> implements AesCmacParamsOrBuilder {
        public Builder() {
            super(AesCmacParams.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02601 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesCmacParams.class, aesCmacParams);
    }
    ...
    public static AesCmacParams parseDelimitedFrom(InputStream inputStream) {
        return (AesCmacParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesCmacParams parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesCmacParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesCmacParams parseFrom(InputStream inputStream) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesCmacParams parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesCmacParams parseFrom(ByteBuffer byteBuffer) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesCmacParams parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesCmacParams parseFrom(C3635j jVar) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesCmacParams parseFrom(C3635j jVar, C3697r rVar) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesCmacParams parseFrom(C3656k kVar) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesCmacParams parseFrom(C3656k kVar, C3697r rVar) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesCmacParams parseFrom(byte[] bArr) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesCmacParams parseFrom(byte[] bArr, C3697r rVar) {
        return (AesCmacParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesCmacParams> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return C3731z.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"tagSize_"});
            case 3:
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesCmacParams> z0Var = PARSER;
                if (z0Var == null) {
