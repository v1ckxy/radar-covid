...
public final class AesGcmHkdfStreamingKey extends C3731z<AesGcmHkdfStreamingKey, Builder> implements AesGcmHkdfStreamingKeyOrBuilder {
    public static final AesGcmHkdfStreamingKey DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    public static final int PARAMS_FIELD_NUMBER = 2;
    public static volatile C3739z0<AesGcmHkdfStreamingKey> PARSER = null;
    ...
    public static /* synthetic */ class C02721 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1470xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1470xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1470xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1470xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1470xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesGcmHkdfStreamingKey.C02721.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesGcmHkdfStreamingKey, Builder> implements AesGcmHkdfStreamingKeyOrBuilder {
        public Builder() {
            super(AesGcmHkdfStreamingKey.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02721 r1) {
            this();
        }
        ...
        public Builder setKeyValue(C3635j jVar) {
            copyOnWrite();
            ((AesGcmHkdfStreamingKey) this.instance).setKeyValue(jVar);
            return this;
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesGcmHkdfStreamingKey.class, aesGcmHkdfStreamingKey);
    }
    ...
    public static AesGcmHkdfStreamingKey parseDelimitedFrom(InputStream inputStream) {
        return (AesGcmHkdfStreamingKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesGcmHkdfStreamingKey parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesGcmHkdfStreamingKey parseFrom(InputStream inputStream) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesGcmHkdfStreamingKey parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesGcmHkdfStreamingKey parseFrom(ByteBuffer byteBuffer) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesGcmHkdfStreamingKey parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesGcmHkdfStreamingKey parseFrom(C3635j jVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesGcmHkdfStreamingKey parseFrom(C3635j jVar, C3697r rVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesGcmHkdfStreamingKey parseFrom(C3656k kVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesGcmHkdfStreamingKey parseFrom(C3656k kVar, C3697r rVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesGcmHkdfStreamingKey parseFrom(byte[] bArr) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesGcmHkdfStreamingKey parseFrom(byte[] bArr, C3697r rVar) {
        return (AesGcmHkdfStreamingKey) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesGcmHkdfStreamingKey> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesGcmHkdfStreamingKey> z0Var = PARSER;
                if (z0Var == null) {
