...
public final class EcdsaKeyFormat extends C3731z<EcdsaKeyFormat, Builder> implements EcdsaKeyFormatOrBuilder {
    public static final EcdsaKeyFormat DEFAULT_INSTANCE;
    public static final int PARAMS_FIELD_NUMBER = 2;
    public static volatile C3739z0<EcdsaKeyFormat> PARSER;
    public EcdsaParams params_;

    /* renamed from: com.google.crypto.tink.proto.EcdsaKeyFormat$1 */
    public static /* synthetic */ class C02821 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1479xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1479xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1479xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1479xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1479xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.EcdsaKeyFormat.C02821.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<EcdsaKeyFormat, Builder> implements EcdsaKeyFormatOrBuilder {
        public Builder() {
            super(EcdsaKeyFormat.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02821 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(EcdsaKeyFormat.class, ecdsaKeyFormat);
    }
    ...
    public static EcdsaKeyFormat parseDelimitedFrom(InputStream inputStream) {
        return (EcdsaKeyFormat) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static EcdsaKeyFormat parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (EcdsaKeyFormat) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static EcdsaKeyFormat parseFrom(InputStream inputStream) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static EcdsaKeyFormat parseFrom(InputStream inputStream, C3697r rVar) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static EcdsaKeyFormat parseFrom(ByteBuffer byteBuffer) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static EcdsaKeyFormat parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static EcdsaKeyFormat parseFrom(C3635j jVar) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static EcdsaKeyFormat parseFrom(C3635j jVar, C3697r rVar) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static EcdsaKeyFormat parseFrom(C3656k kVar) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static EcdsaKeyFormat parseFrom(C3656k kVar, C3697r rVar) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static EcdsaKeyFormat parseFrom(byte[] bArr) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static EcdsaKeyFormat parseFrom(byte[] bArr, C3697r rVar) {
        return (EcdsaKeyFormat) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<EcdsaKeyFormat> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<EcdsaKeyFormat> z0Var = PARSER;
                if (z0Var == null) {
