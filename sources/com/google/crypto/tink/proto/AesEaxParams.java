...
public final class AesEaxParams extends C3731z<AesEaxParams, Builder> implements AesEaxParamsOrBuilder {
    public static final AesEaxParams DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    public static volatile C3739z0<AesEaxParams> PARSER;
    public int ivSize_;

    /* renamed from: com.google.crypto.tink.proto.AesEaxParams$1 */
    public static /* synthetic */ class C02711 {

        /* renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        public static final /* synthetic */ int[] f1469xa1df5c61;
        ...
        static {
            ...
            L_0x001d:
                r0 = 5
                int[] r2 = f1469xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0024 }
            ...
            L_0x0024:
                r2 = 6
                int[] r3 = f1469xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002b }
            ...
            L_0x002b:
                int[] r0 = f1469xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f1469xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0039 }
            ...
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.proto.AesEaxParams.C02711.<clinit>():void");
        }
    }

    public static final class Builder extends C3732a<AesEaxParams, Builder> implements AesEaxParamsOrBuilder {
        public Builder() {
            super(AesEaxParams.DEFAULT_INSTANCE);
        }

        public /* synthetic */ Builder(C02711 r1) {
            this();
        }
    ...
    static {
        ...
        C3731z.registerDefaultInstance(AesEaxParams.class, aesEaxParams);
    }
    ...
    public static AesEaxParams parseDelimitedFrom(InputStream inputStream) {
        return (AesEaxParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesEaxParams parseDelimitedFrom(InputStream inputStream, C3697r rVar) {
        return (AesEaxParams) C3731z.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesEaxParams parseFrom(InputStream inputStream) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static AesEaxParams parseFrom(InputStream inputStream, C3697r rVar) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, inputStream, rVar);
    }

    public static AesEaxParams parseFrom(ByteBuffer byteBuffer) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static AesEaxParams parseFrom(ByteBuffer byteBuffer, C3697r rVar) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, byteBuffer, rVar);
    }

    public static AesEaxParams parseFrom(C3635j jVar) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static AesEaxParams parseFrom(C3635j jVar, C3697r rVar) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, jVar, rVar);
    }

    public static AesEaxParams parseFrom(C3656k kVar) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar);
    }

    public static AesEaxParams parseFrom(C3656k kVar, C3697r rVar) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, kVar, rVar);
    }

    public static AesEaxParams parseFrom(byte[] bArr) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static AesEaxParams parseFrom(byte[] bArr, C3697r rVar) {
        return (AesEaxParams) C3731z.parseFrom(DEFAULT_INSTANCE, bArr, rVar);
    }

    public static C3739z0<AesEaxParams> parser() {
    ...
    public final Object dynamicMethod(C3738g gVar, Object obj, Object obj2) {
        switch (gVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C3739z0<AesEaxParams> z0Var = PARSER;
                if (z0Var == null) {
