...
/* renamed from: q.b.a.b.g.e.s0 */
public final /* synthetic */ class C2661s0 {
    ...
    static {
        /*
            int[] r0 = p213q.p217b.p218a.p231b.p251g.p256e.C2490i6.C2496f.m5972a()
            int r0 = r0.length
            int[] r0 = new int[r0]
            f6857a = r0
            r1 = 1
        ...
        L_0x000d:
            r0 = 2
            r3 = 4
            int[] r4 = f6857a     // Catch:{ NoSuchFieldError -> 0x0013 }
            r4[r3] = r0     // Catch:{ NoSuchFieldError -> 0x0013 }
        L_0x0013:
            int[] r4 = f6857a     // Catch:{ NoSuchFieldError -> 0x0017 }
            r4[r0] = r2     // Catch:{ NoSuchFieldError -> 0x0017 }
        L_0x0017:
            r0 = 5
            int[] r2 = f6857a     // Catch:{ NoSuchFieldError -> 0x001c }
            r2[r0] = r3     // Catch:{ NoSuchFieldError -> 0x001c }
        L_0x001c:
            r2 = 6
            int[] r3 = f6857a     // Catch:{ NoSuchFieldError -> 0x0021 }
            r3[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0021 }
        L_0x0021:
            int[] r0 = f6857a     // Catch:{ NoSuchFieldError -> 0x0026 }
            r3 = 0
            r0[r3] = r2     // Catch:{ NoSuchFieldError -> 0x0026 }
        L_0x0026:
            int[] r0 = f6857a     // Catch:{ NoSuchFieldError -> 0x002b }
            r2 = 7
            r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002b }
        L_0x002b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p213q.p217b.p218a.p231b.p251g.p256e.C2661s0.<clinit>():void");
    }
}
