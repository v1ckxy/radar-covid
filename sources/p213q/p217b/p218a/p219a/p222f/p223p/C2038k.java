...
/* renamed from: q.b.a.a.f.p.k */
public class C2038k implements C2031e {

    /* renamed from: a */
    public final C2039a f5821a;

    /* renamed from: b */
    public final C2036i f5822b;

    /* renamed from: c */
    public final Map<String, C2041m> f5823c = new HashMap();

    /* renamed from: q.b.a.a.f.p.k$a */
    public static class C2039a {
        ...
        /* renamed from: b */
        public Map<String, String> f5825b = null;

        public C2039a(Context context) {
            this.f5824a = context;
        }

        /* JADX WARNING: type inference failed for: r2v9, types: [java.util.Map<java.lang.String, java.lang.String>] */
        /* JADX WARNING: type inference failed for: r2v10 */
        /* JADX WARNING: type inference failed for: r2v12, types: [java.util.Map] */
        ...
        public p213q.p217b.p218a.p219a.p222f.p223p.C2030d mo7029a(java.lang.String r15) {
            /*
                r14 = this;
                java.lang.String r0 = "Could not instantiate %s"
                java.lang.String r1 = "Could not instantiate %s."
                java.util.Map<java.lang.String, java.lang.String> r2 = r14.f5825b
                r3 = 0
                java.lang.String r4 = "BackendRegistry"
                r5 = 0
                if (r2 != 0) goto L_0x0093
                android.content.Context r2 = r14.f5824a
            ...
            L_0x009e:
                ...
                java.lang.Class<q.b.a.a.f.p.d> r7 = p213q.p217b.p218a.p219a.p222f.p223p.C2030d.class
                ...
                q.b.a.a.f.p.d r6 = (p213q.p217b.p218a.p219a.p222f.p223p.C2030d) r6     // Catch:{ ClassNotFoundException -> 0x00e3, IllegalAccessException -> 0x00d9, InstantiationException -> 0x00cf, NoSuchMethodException -> 0x00c2, InvocationTargetException -> 0x00b8 }
                return r6
            L_0x00b8:
                r1 = move-exception
            ...
            L_0x00f1:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p213q.p217b.p218a.p219a.p222f.p223p.C2038k.C2039a.mo7029a(java.lang.String):q.b.a.a.f.p.d");
        }
    }

    public C2038k(Context context, C2036i iVar) {
        C2039a aVar = new C2039a(context);
        this.f5821a = aVar;
        this.f5822b = iVar;
    }

    /* renamed from: a */
    public synchronized C2041m mo7028a(String str) {
        if (this.f5823c.containsKey(str)) {
            return (C2041m) this.f5823c.get(str);
        }
        C2030d a = this.f5821a.mo7029a(str);
        if (a == null) {
            return null;
        }
        C2036i iVar = this.f5822b;
        C2041m create = a.create(new C2029c(iVar.f5815a, iVar.f5816b, iVar.f5817c, str));
        this.f5823c.put(str, create);
        return create;
    }
}
