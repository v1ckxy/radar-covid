package p213q.p217b.p355e.p357v.p359z.p360d;

import java.util.TimeZone;
import p213q.p214a.p215a.p216a.C1965a;

/* renamed from: q.b.e.v.z.d.a */
public class C4395a {

    /* renamed from: a */
    public static final TimeZone f10458a = TimeZone.getTimeZone("UTC");

    /* renamed from: a */
    public static int m9934a(String str, int i, int i2) {
        int i3;
        int i4;
    ...
    public static java.util.Date m9935a(java.lang.String r17, java.text.ParsePosition r18) {
        /*
            r1 = r17
            r2 = r18
            int r0 = r18.getIndex()     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r3 = r0 + 4
            int r0 = m9934a(r1, r0, r3)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r4 = 45
            boolean r5 = m9936a(r1, r3, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r5 == 0) goto L_0x0018
            int r3 = r3 + 1
        L_0x0018:
            int r5 = r3 + 2
            int r3 = m9934a(r1, r3, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            boolean r6 = m9936a(r1, r5, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r6 == 0) goto L_0x0026
            int r5 = r5 + 1
        L_0x0026:
            int r6 = r5 + 2
            int r5 = m9934a(r1, r5, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r7 = 84
            boolean r7 = m9936a(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r8 = 1
        ...
        L_0x0049:
            ...
            int r6 = r6 + 1
            int r7 = r6 + 2
            int r6 = m9934a(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r12 = 58
            boolean r13 = m9936a(r1, r7, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r13 == 0) goto L_0x0062
            int r7 = r7 + 1
        L_0x0062:
            int r13 = r7 + 2
            int r7 = m9934a(r1, r7, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            boolean r12 = m9936a(r1, r13, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
        ...
        L_0x0070:
            ...
            int r4 = r13 + 2
            int r12 = m9934a(r1, r13, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r13 = 59
        ...
        L_0x0090:
            r13 = 46
            boolean r13 = m9936a(r1, r4, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
        ...
        L_0x00b6:
            ...
            int r15 = m9934a(r1, r4, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r14 = r14 - r4
        ...
        L_0x00db:
            ...
            java.util.TimeZone r9 = f10458a     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r4 = r4 + r8
            goto L_0x0197
        L_0x00ed:
        ...
        L_0x0213:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p213q.p217b.p355e.p357v.p359z.p360d.C4395a.m9935a(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: a */
    public static boolean m9936a(String str, int i, char c) {
