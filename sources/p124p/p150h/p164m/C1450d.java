...
/* renamed from: p.h.m.d */
public class C1450d implements Callback {

    /* renamed from: a */
    public final Callback f4253a;
    ...
    public C1450d(Callback callback, TextView textView) {
        this.f4253a = callback;
        this.f4254b = textView;
    }

    public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        return this.f4253a.onActionItemClicked(actionMode, menuItem);
    }

    public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        return this.f4253a.onCreateActionMode(actionMode, menu);
    }

    public void onDestroyActionMode(ActionMode actionMode) {
        this.f4253a.onDestroyActionMode(actionMode);
    }

    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00c9, code lost:
        if (r0.checkSelfPermission(r9) != 0) goto L_0x00cc;
     */
    ...
    public boolean onPrepareActionMode(android.view.ActionMode r13, android.view.Menu r14) {
        /*
            r12 = this;
            android.widget.TextView r0 = r12.f4254b
            android.content.Context r0 = r0.getContext()
            android.content.pm.PackageManager r1 = r0.getPackageManager()
            boolean r2 = r12.f4258f
            ...
            r12.f4255c = r2     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            ...
            r12.f4256d = r2     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            r12.f4257e = r5     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            goto L_0x0032
        L_0x002b:
            r2 = 0
            r12.f4255c = r2
            ...
            r12.f4257e = r4
        L_0x0032:
            boolean r2 = r12.f4257e     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            if (r2 == 0) goto L_0x0041
            java.lang.Class<?> r2 = r12.f4255c     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            boolean r2 = r2.isInstance(r14)     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            if (r2 == 0) goto L_0x0041
            java.lang.reflect.Method r2 = r12.f4256d     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            goto L_0x004f
        L_0x0041:
        ...
        L_0x00d6:
            ...
            android.widget.TextView r9 = r12.f4254b
        ...
        L_0x010e:
            ...
            goto L_0x00d6
        L_0x0129:
            android.view.ActionMode$Callback r0 = r12.f4253a
            boolean r13 = r0.onPrepareActionMode(r13, r14)
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: p124p.p150h.p164m.C1450d.onPrepareActionMode(android.view.ActionMode, android.view.Menu):boolean");
    }
}
