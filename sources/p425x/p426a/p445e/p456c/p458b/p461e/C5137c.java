...
/* renamed from: x.a.e.c.b.e.c */
public class C5137c extends KeyFactorySpi implements C5023b {
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            try {
                return new C5135a(C4946b.m11184a(C4983s.m11325a(((PKCS8EncodedKeySpec) keySpec).getEncoded())));
            } catch (Exception e) {
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        if (keySpec instanceof X509EncodedKeySpec) {
            try {
                return new C5136b(C4951b.m11202a(((X509EncodedKeySpec) keySpec).getEncoded()));
            } catch (Exception e) {
                throw new InvalidKeySpecException(e.toString());
            }
        } else {
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) {
        boolean z = key instanceof C5135a;
        String str = Strings.CURRENT_PATH;
        if (z) {
            if (PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new PKCS8EncodedKeySpec(key.getEncoded());
            }
        } else if (!(key instanceof C5136b)) {
    ...
    public final Key engineTranslateKey(Key key) {
        if ((key instanceof C5135a) || (key instanceof C5136b)) {
            return key;
        }
